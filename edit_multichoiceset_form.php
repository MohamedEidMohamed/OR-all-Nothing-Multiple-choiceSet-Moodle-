...
class qtype_multichoiceset_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $mform->addElement('header', 'nameforyourheaderelement', get_string('Minus', 'modulename'));

        $mform->addElement('static', 'question','Add Minus "Select Y/N"');
        $radioarray=array();
        ...
        $mform->addElement('text','numeric', get_string('Add a Number Of Minus :'),'maxlength="5" size="3"');
